...
namespace FileWatcherEx
{
    ...
    public class FileSystemWatcherEx : IDisposable, IFileSystemWatcherEx
    {
        ...
        private readonly BlockingCollection<FileChangedEvent> _fileEventQueue = new BlockingCollection<FileChangedEvent>();
        ...
        /// </summary>
        public System.Collections.ObjectModel.Collection<string> Filters { get; } = new System.Collections.ObjectModel.Collection<string>();
