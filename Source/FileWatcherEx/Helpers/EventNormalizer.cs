...
namespace FileWatcherEx.Helpers
{
    ...
    {
        private readonly FileEventRepository _eventRepo = new FileEventRepository();
        ...
        {
            private readonly Dictionary<string, FileChangedEvent> _mapPathToEvents = new Dictionary<string, FileChangedEvent>();
